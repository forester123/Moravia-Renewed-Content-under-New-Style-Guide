...
已注册的中期许可接受方可以访问 [SSPK 分发门户](https://microsoft.sharepoint.com/teams/SSPKDOWNLOAD/)。

中期和最终 SSPK 许可接受方可以将技术问题提交到 [smoothpk@microsoft.com](mailto:smoothpk@microsoft.com)。
