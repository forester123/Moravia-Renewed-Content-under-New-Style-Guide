...
content\_key\_specs | JSON 结构的数组，请参阅下面的**内容密钥规范** | 更精细地控制要返回的内容密钥。有关详细信息，请参阅下面的“内容密钥规范”。只能指定 allowed\_track\_types 和 content\_key\_specs 中的一个。 
...
content\_key\_specs.key\_id| Base64 编码的二进制字符串，16 个字节 | 密钥的唯一标识符。 
