---
标题：Azure SQL 弹性缩放常见问题 | Microsoft 文档说明：有关 Azure SQL 数据库弹性缩放的常见问题。services: sql-database documentationcenter: '' manager: jhubbard author: ddove editor: ''

ms.assetid: e60dde9c-bb7b-4f2f-b52c-bdb506d49fcb ms.service: sql-database ms.workload: sql-database ms.tgt_pltfrm: na ms.devlang: na ms.topic: article ms.date: 10/24/2016 ms.author: ddove
