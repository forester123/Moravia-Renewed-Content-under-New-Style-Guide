...
[AZURE.INCLUDE [azure-arm-classic-important-include](../includes/azure-arm-classic-important-include.md)] 本文介绍 Resource Manager 部署模型。还可[在经典部署模型中管理静态专用 IP 地址](/documentation/articles/virtual-networks-static-private-ip-classic-ps)。
