...
了解有关 [ServiceConfiguration.cscfg](/documentation/articles/cloud-services/cloud-services-model-and-package/#serviceconfigurationcscfg) 文件的详细信息。

创建 [ServicePackage.cspkg](/documentation/articles/cloud-services/cloud-services-model-and-package/#servicepackagecspkg) 包。

为角色启用[远程桌面](/documentation/articles/cloud-services/cloud-services-role-enable-remote-desktop/)。
