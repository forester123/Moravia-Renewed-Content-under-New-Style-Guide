...
>[AZURE.NOTE] 有关使用 HPC Pack 迸发到 Azure 的教程，请参阅[使用 HPC Pack 设置混合群集](/documentation/articles/cloud-services-setup-hybrid-hpcpack-cluster/)。请注意，以下步骤中的注意事项仅适用于支持 RDMA 的 Azure 节点。
