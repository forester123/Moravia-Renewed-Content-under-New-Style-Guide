...
你可以将 Resource Manager 模板与 Azure PowerShell 配合使用，轻松创建新的基于 Windows 的 Azure 虚拟机。此模板将在新虚拟网络（其新资源组中包含单个子网）中创建运行 Windows 的单个虚拟机。

![](./media/virtual-machines-create-windows-powershell-resource-manager-template/windowsvm.png)

[AZURE.INCLUDE [powershell-preview](../includes/powershell-preview-inline-include.md)]

## 通过 Azure PowerShell 使用 Resource Manager 模板创建 Windows 虚拟机

按照以下步骤，通过 Azure PowerShell 使用 Github 模板存储库中的 Resource Manager 模板创建 Windows 虚拟机。
