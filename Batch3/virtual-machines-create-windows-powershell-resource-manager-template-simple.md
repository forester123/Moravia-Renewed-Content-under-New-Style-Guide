<properties
	...
	description="使用 Resource Manager 模板和 Azure PowerShell 创建新的 Windows 虚拟机。"
...
# 使用 Resource Manager 模板和 PowerShell 创建 Windows 虚拟机

[AZURE.INCLUDE [learn-about-deployment-models](../includes/learn-about-deployment-models-rm-include.md)] 经典部署模型。


你可以将 Resource Manager 模板与 Azure PowerShell 配合使用，轻松创建新的基于 Windows 的 Azure 虚拟机 (VM)。此模板将在新虚拟网络（其新资源组中包含单个子网）中创建运行 Windows 的单个虚拟机。
...
按照以下步骤，通过 Azure PowerShell 使用 Github 模板存储库中的 Resource Manager 模板创建 Windows VM。
...
[使用 Azure Resource Manager 和 PowerShell 创建 Windows 虚拟机](/documentation/articles/virtual-machines-create-windows-powershell-resource-manager)
