...
可在[此处](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/IaaS-Story/11-MultiNIC/classic/multinic.sh)下载所用的完整 bash 脚本。按照以下步骤更改脚本，以便用于具体环境。
