<properties 
   pageTitle="在 Resource Manager 中使用模板部署多 NIC VM | Microsoft Azure"
...
公共存储库中提供的示例模板使用一参数文件，该文件包含用于生成上述方案的默认值。若要使用单击部署来部署此模板，请打开[此链接](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/IaaS-Story/11-MultiNIC)，在“后端资源组(参见文档)”右侧单击“部署至 Azure”，根据需要替换默认参数值，然后按照门户中的说明进行操作。
...
1. 如果从未使用过 Azure CLI，请参阅[安装和配置 Azure CLI](/documentation/articles/xplat-cli)，并按照说明进行操作，直到选择 Azure 帐户和订阅。
