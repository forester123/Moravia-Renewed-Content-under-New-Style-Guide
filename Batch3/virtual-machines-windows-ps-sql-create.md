...
[AZURE.INCLUDE [learn-about-deployment-models](../includes/learn-about-deployment-models-rm-include.md)] 经典部署模型。如果需要本主题的经典版本，请参阅[使用 Azure PowerShell 预配 SQL Server 虚拟机（经典）](/documentation/articles/virtual-machines-windows-classic-ps-sql-create)。
...
现在，你可以在 Azure 门户中查看此虚拟机，以查看[其公共 IP 地址及完全限定的域名](/documentation/articles/virtual-machines-windows-portal-sql-server-provision#Connect)。
