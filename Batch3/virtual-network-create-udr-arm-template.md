...
[AZURE.INCLUDE [azure-arm-classic-important-include](../includes/azure-arm-classic-important-include.md)] 本文介绍 Resource Manager 部署模型。还可[在经典部署模型中创建 UDR](/documentation/articles/virtual-networks-udr-how-to)。
...
公共存储库中提供的示例模板使用一参数文件，该文件包含用于生成上述方案的默认值。若要使用单击部署来部署此模板，请跟随[此链接](https://github.com/telmosampaio/azure-templates/tree/master/IaaS-NSG-UDR)，单击“部署至 Azure”，根据需要替换默认参数值，然后按照门户中的说明进行操作。
