...
如果拥有多个 Azure 订阅，将调用 **Select-AzureSubscription**。
...
>[AZURE.NOTE] 只支持使用 HDInsight 3.1.3 或更高版本的群集。如果不确定群集的版本，可以查看“属性”页。请参阅[熟悉群集门户界面](/documentation/articles/hdinsight-administer-use-management-portal-v1#Get-familiar-with-the-cluster-portal-interface)。
