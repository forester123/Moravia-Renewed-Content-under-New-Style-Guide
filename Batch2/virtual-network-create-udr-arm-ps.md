<properties 
   pageTitle="使用 PowerShell 在 Resource Manager 中控制路由和使用虚拟设备 | Microsoft Azure"
...
[AZURE.INCLUDE [azure-arm-classic-important-include](../includes/azure-arm-classic-important-include.md)]本文介绍 Resource Manager 部署模型。还可[在经典部署模型中创建 UDR](/documentation/articles/virtual-network-create-udr-classic-ps)。
