...
# 教程：在 Microsoft Azure 存储中使用 Azure 密钥保管库加密和解密 Blob
## 介绍
...
注意：硬编码值 $key 仅用于演示目的。请在自己的代码中生成此密钥。
...
## 后续步骤
有关将 Microsoft Azure 存储与 C# 配合使用的详细信息，请参阅[适用于 .NET 的 Microsoft Azure 存储客户端库](https://msdn.microsoft.com/zh-cn/library/azure/dn261237.aspx)。
