...
## 后续步骤
- [使用 Azure 门户为 VM 部署静态公共 IP](/documentation/articles/virtual-network-deploy-static-pip-arm-portal/)
- [使用模板为 VM 部署静态公共 IP](/documentation/articles/virtual-network-deploy-static-pip-arm-template/)
- [通过 Azure 门户为 VM 部署静态专用 IP 地址](/documentation/articles/virtual-networks-static-private-ip-arm-pportal/)
