...
答：成功连接到 https://media.chinacloudapi.cn 之后，会接收到指定另一个媒体服务 URI 的 301 重定向。必须根据[使用 REST API 连接到媒体服务](/documentation/articles/media-services-rest-connect_programmatically/)中所述内容对新的 URI 执行后续调用。
