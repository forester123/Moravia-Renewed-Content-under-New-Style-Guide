...
创建 SQL Server 映像时，请[使用 Azure PowerShell（经典）设置 SQL Server 虚拟机](/documentation/articles/virtual-machines-windows-classic-ps-sql-create/)。使用经典部署模型设置的 SQL Server VM 将实施所有这些最佳实践，包括存储配置。
