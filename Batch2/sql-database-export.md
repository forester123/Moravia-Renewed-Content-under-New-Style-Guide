...
<tags ms.service="sql-database" ms.date="08/15/2016" wacn.date="04/22/2016"
...
本文说明了如何使用 [Azure 门户](https://portal.azure.cn)将 Azure SQL 数据库存档到 BACPAC 文件（存储在 Azure Blob 存储中）。
