<properties
	...
	description="演示一个示例 PHP 程序，该程序可以从 Windows 客户端连接到 Azure SQL 数据库，并提供指向客户端所需的必要软件组件的链接。"
...
本主题演示了如何从在 Windows 上运行的、以 PHP 编写的客户端应用程序连接到 Azure SQL 数据库。
...
此 **OpenConnection** 函数将在其后面的所有函数的顶部附近调用。
