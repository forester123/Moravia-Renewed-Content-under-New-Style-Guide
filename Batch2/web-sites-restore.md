...
>[AZURE.NOTE] 如果你想要在注册 Azure 帐户之前开始使用 Azure App Service，请转到[试用 App Service](https://tryappservice.azure.com/)，你可以在 App Service 中立即创建一个生存期较短的入门 Web 应用。无需付费，也不需要做出任何承诺。
