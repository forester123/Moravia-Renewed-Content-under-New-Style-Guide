...
>
>此外，资产必须包含一组自适应比特率 MP4 或自适应比特率平滑流式处理文件。
...
>成功连接到 https://media.chinacloudapi.cn 之后，将接收到 301 重定向，指定另一媒体服务 URI。必须根据[使用 REST API 连接到媒体服务](/documentation/articles/media-services-rest-connect_programmatically/)中所述对新的 URI 执行后续调用。
