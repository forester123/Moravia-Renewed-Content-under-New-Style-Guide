...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)] 本文档介绍如何使用 Resource Manager 部署模型创建 VNet。还可[通过 Azure CLI 使用经典部署模型创建虚拟网络](virtual-networks-create-vnet-classic-cli.md)。
