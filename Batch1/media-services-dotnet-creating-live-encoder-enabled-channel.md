...
- 一个媒体服务帐户。若要创建媒体服务帐户，请参阅[创建帐户](/documentation/articles/media-services-portal-create-account/)。
...
>[AZURE.NOTE]若要查找 Name 和 Key 值，请转到 Azure 门户，然后选择帐户。“设置”窗口在右侧显示。在“设置”窗口中，选择“密钥”。单击每个文本框旁边的图标将值复制到系统剪贴板中。
