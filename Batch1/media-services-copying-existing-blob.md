...
本主题介绍如何将存储帐户中的 blob 复制到新的 Microsoft Azure 媒体服务资产。
...
- 在新的或现有的 Azure 订阅中拥有两个媒体服务帐户。请参阅主题[如何创建媒体服务帐户](/documentation/articles/media-services-portal-create-account/)。
