...
本教程介绍如何使用 Visual Studio 工具，通过远程运行[调试模式](/documentation/services/web-sites/)或查看应用程序日志和 Web 服务器日志帮助调试 [Azure Web 应用](http://www.visualstudio.com/get-started/debug-your-app-vs.aspx)中的 Web 应用。
...
通过 Visual Studio，用户可以访问 [Azure 门户](https://manage.windowsazure.cn/)中提供的 Web 应用管理功能和配置设置的子集。本节介绍使用**服务器资源管理器**可以实现的功能。若要了解最新的 Azure 集成功能，请同时试用**云资源管理器**。可以从“视图”菜单打开这两个窗口。
...
8. 单击“查看所有应用程序日志”。
	...
	该视图将显示任何其他视图都没提供的额外字段。该视图还支持使用特殊的 Query Builder UI 构建查询以筛选日志。有关详细信息，请参阅[通过服务器资源管理器浏览存储资源](http://msdn.microsoft.com/zh-cn/library/ff683677.aspx)中的“使用表资源 - 筛选实体”。
...
3. 在 [Azure 门户](https://portal.azure.cn)中 Web 应用的“设置”边栏选项卡上，单击“部署凭据”，然后输入新的用户名和密码。
...
* [远程调试 Azure Web 应用简介](/blog/2014/05/06/introduction-to-remote-debugging-on-azure-web-sites/)。
* [Azure Web 应用远程调试简介第 2 部分 - 远程调试洞析](/blog/2014/05/07/introduction-to-remote-debugging-azure-web-sites-part-2-inside-remote-debugging/)
* [Azure Web 应用远程调试简介第 3 部分 - 多实例环境和 GIT](/blog/2014/05/08/introduction-to-remote-debugging-on-azure-web-sites-part-3-multi-instance-environment-and-git/)
