...
本教程介绍如何在 [Azure App Service Web Apps](/documentation/services/web-sites/) 中运行 Python。Web Apps 提供有限的免费托管和快速部署功能，现在，你可以使用 Python！ 随着应用的增长，可以切换到付费托管，并且还可以与所有其他 Azure 服务集成。
