...
Microsoft Azure 媒体服务是一个可扩展的基于云的平台，使开发人员能够生成可缩放的媒体管理和传送应用程序。媒体服务基于 REST API，可以使用这些 API 安全地上传、存储、编码和打包视频或音频内容，以供点播和以实时流形式传送到各种客户端（例如，电视、电脑和移动设备）。
...
2. Azure 媒体服务帐户。使用 Azure 门户、.NET 或 REST API 创建 Azure 媒体服务帐户。有关详细信息，请参阅[创建帐户](/documentation/articles/media-services-portal-create-account/)。
...
4. （推荐）分配一个或多个缩放单位。建议为生产环境中的应用程序分配一个或多个缩放单位。有关详细信息，请参阅[管理流式处理终结点](/documentation/articles/media-services-portal-manage-streaming-endpoints/)。
...
2. 使用下述媒体分析服务之一来处理视频：
	...
	- **Indexer** – [使用 Azure Media Indexer 2 处理视频](/documentation/articles/media-services-process-content-with-indexer2/)
...
媒体服务支持与 Azure CDN 集成。有关如何启用 Azure CDN 的信息，请参阅[如何在媒体服务帐户中管理流式处理终结点](/documentation/articles/media-services-portal-manage-streaming-endpoints/)。
...
[本](/documentation/articles/media-services-portal-scale-streaming-endpoints/)主题链接到相关的主题。
