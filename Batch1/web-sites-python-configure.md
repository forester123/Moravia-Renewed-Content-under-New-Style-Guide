...
本教程介绍在 [Azure App Service Web 应用](/documentation/services/web-sites/)中创作和配置符合基本 Web 服务器网关接口 (WSGI) 的 Python 应用程序的选项。

其中讲解了 Git 部署的一些功能，如使用 requirements.txt 安装虚拟环境和包。

##<a name="bottle-django-flask"></a> Bottle、Django 还是 Flask？

如果你正在 Azure 中开发第一个 Web 应用，或者不熟悉 Git，我们建议你参考以下教程之一，其中包括用于从 Windows 或 Mac 使用 Git 部署从库构建工作应用程序的分步说明：
