...
- 通过 [Azure 门户](https://portal.azure.cn)设置。
...
- [Authentication for the Azure Storage Services（Azure 存储服务的身份验证）](https://msdn.microsoft.com/zh-cn/library/azure/dd179428.aspx)
