<properties 
	...
	description="本教程将介绍如何通过使用 Visual Studio 将使用 ASP.NET Web API 的应用程序部署到 Azure 网站。" 
...
<a name="bkmk_setupdevenv"></a> <!-- the next line produces the "Set up the development environment" section as see at /documentation/articles/web-sites-dotnet-get-started/ --> [AZURE.INCLUDE [create-account-and-websites-note](../includes/create-account-and-websites-note.md)]
...
1. 按 Ctrl+F5 运行应用程序。随后在默认浏览器中显示该应用程序主页。![待办事项列表主页](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rr5.png)
...
9. 输入一个联系人（跟在本地运行应用程序时所做的一样）以验证数据库部署是否成功。
