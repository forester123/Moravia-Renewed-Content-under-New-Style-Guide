...
>[AZURE.NOTE] 此文档中的信息特定于基于 Windows 的 HDInsight 群集。有关基于 Linux 的群集的信息，请参阅 [Hadoop 教程：在 HDInsight 中使用基于 Linux 的 Hadoop 入门](/documentation/articles/hdinsight-hadoop-tutorial-get-started-windows-v1/)。
...
2. 单击“新建”，单击“数据分析”，然后单击“HDInsight”。该门户将打开“新建 HDInsight 群集”边栏选项卡。
    ...
    ![在 Azure 门户中创建新群集](./media/hdinsight-hadoop-tutorial-get-started-windows-v1/HDI.CreateCluster.1.png "在 Azure 门户中创建新群集")  
