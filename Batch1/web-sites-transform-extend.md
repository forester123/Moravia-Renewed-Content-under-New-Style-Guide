<properties
	pageTitle="Azure App Service Web 应用高级配置和扩展"
...
使用 [XML 文档转换](http://msdn.microsoft.com/zh-cn/library/dd465326.aspx) (XDT) 声明，可以转换 Azure App Service中 Web 应用的 [ApplicationHost.config](http://www.iis.net/learn/get-started/planning-your-iis-architecture/introduction-to-applicationhostconfig) 文件。你还可使用 XDT 声明添加专用扩展，启用自定义 Web 应用管理操作。本文包括一个 PHP Manager Web 应用扩展示例，可用于通过 Web 界面管理 PHP 设置。
...
**注意**<br />无法删除或重新排序 `system.webServer` 的模块列表中的元素，但可以删除或重新排列排序列表的附加内容。
