...
在 **StorageSample** 类中，声明一个将包含默认终结点协议、存储帐户名称和存储访问密钥（在 Azure 存储帐户中指定）的字符串变量。将占位符值 **your\_account\_name** 和 **your\_account\_key** 分别替换为自己的帐户名称和帐户密钥。
...
- [Azure Storage Services REST API](https://msdn.microsoft.com/zh-cn/library/azure/dd179355.aspx)（Azure 存储服务 REST API）
